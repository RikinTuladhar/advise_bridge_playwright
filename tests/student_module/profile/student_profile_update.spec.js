...
test("Student Dashboard", async ({ page }) => {
  ...
  await expect(page).toHaveURL("/student/students/1478?tab=-profile-tab");
  ...
  // await expect(page).toHaveURL("/student/students/1478?tab=-address-tab");
  // await page.waitForTimeout(3000);
  // // Select Country
  ...
  // await expect(page).toHaveURL("/student/students/1478?tab=-language-tab");
  // await page.waitForTimeout(2000);
  ...
  // await expect(page).toHaveURL("/student/students/1478?tab=-gpa-kse-tab");
  // await page.waitForTimeout(2000);
  // // GPA Scale
  ...
  // await expect(page).toHaveURL("/student/students/1478?tab=-academics-tab");
  // await page.waitForTimeout(5000);
  ...
  // await expect(page).toHaveURL("/student/students/1478?tab=-emergency-tab");
  // await page.waitForTimeout(5000);
  ...
  // await expect(page).toHaveURL("/student/students/1478?tab=-consent-tab");
  // await page.waitForTimeout(5000);
