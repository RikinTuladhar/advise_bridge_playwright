...
//   // await page.locator('.choices__list choices__list--dropdown', { hasText: '0-4' }).click();
//   // await page.waitForTimeout(1000); 

//   // Click to open dropdown
// await page.locator('.choices__inner', { 
//   has: page.locator('#data\\.gpa_id') 
// }).click();
...
// await page.locator('.choices__item--choice', { 
//   hasText: '0-4' 
// }).first().click();
...
//   // await page.locator('.choices_list--dropdown .choices_item', { hasText: 'GRE' }).click();
//   // await page.waitForTimeout(1000);

//  // Click using data-value attribute to open dropdown
// await page.locator('[data-value="12"][data-deletable]').click();
