...
test("Student Dashboard", async ({ page }) => {
    ...
    await page.locator('.choices__inner').nth(4).click();
    ...
    await expect(page.locator('.choices__inner .choices__item--selectable').nth(4)).toContainText('Nepal');
    await page.waitForTimeout(2000);
    // Open State dropdown
    ...
    await expect(page.locator('.choices__inner .choices__item--selectable').nth(5)).toContainText('Madhesh');
    await page.waitForTimeout(2000);
    // Open City dropdown
    await page.locator('.choices__inner').nth(6).click();
    const searchCity = page.getByRole('textbox', { name: 'Select City' });
    await page.waitForTimeout(2000);
    await searchCity.type('Bara');
    await page.waitForTimeout(3000);
    await searchCity.press('Enter');
    await expect(page.locator('.choices__inner .choices__item--selectable').nth(6)).toContainText('Bara');
    await page.waitForTimeout(2000);
